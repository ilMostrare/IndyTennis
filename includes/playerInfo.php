...
function GetPlayerPastMatches($playerID){
    ...
    while ($pastMatchesRow = mysqli_fetch_assoc($pastMatchesQuery)) {
        ...
        $mIDLen = strlen($pastMatchID);
        $mID = 0;
        switch ((string)$mIDLen){
            case "3":
                $mID = (int)substr($pastMatchID,2,1);
            case "4":
                $mID = (int)substr($pastMatchID,2,2);
            case "5":
                $mID = (int)substr($pastMatchID,2,3);
            case "6":
                $mID = (int)substr($pastMatchID,2,4);
            case "7":
                $mID = (int)substr($pastMatchID,2,5);
            case "8":
                $mID = (int)substr($pastMatchID,2,6);
            case "9":
                $mID = (int)substr($pastMatchID,2,7);
            case "10":
                $mID = (int)substr($pastMatchID,2,8);
            case "11":
                $mID = (int)substr($pastMatchID,2,9);
            case "12":
                $mID = (int)substr($pastMatchID,2,10);
            case "13":
                $mID = (int)substr($pastMatchID,2,11);
            case "14":
                $mID = (int)substr($pastMatchID,2,12);
            case "15":
                $mID = (int)substr($pastMatchID,2,13);
        }
        ...
        if ($identifier == 'SG'){
            ...
            switch ((string)$mIDLen){
                case "12":
                    $TDMatchID = (string)substr($pastMatchID,2,10);
                case "13":
                    $TDMatchID = (string)substr($pastMatchID,2,11);
                case "14":
                    $TDMatchID = (string)substr($pastMatchID,2,12);
                case "15":
                    $TDMatchID = (string)substr($pastMatchID,2,13);
            }
